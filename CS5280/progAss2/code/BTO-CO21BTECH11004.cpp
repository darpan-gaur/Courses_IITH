...
class dataItem {
    public:
        ...
        int R_TS; // max-read timestamp 
        int W_TS; // max-write timestamp
...
BTOscheduler* scheduler;

// open output file
FILE *logFile = fopen("BTOlog.txt", "w");
...
int main() {
    ...
    // cout << (double)totalDelay/(numTrans) << " " << (double)totalAborts/(numTrans) << endl;
